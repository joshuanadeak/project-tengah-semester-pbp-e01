...
### 1. Main Page (Django App: `authenticate`) - Main Page by Christopher, Login and Register by Joshua, and Logout by Azka
...
### 2. Investing in Crypto (Django App: `crypto`) - Joshua Mihai Daniel Nadeak (2106635285)
...
### 3. Investing in Stocks (Django App: `stock`) - Christopher Nathanael Wijaya (2106630044)
...
### 4. Registration For Companies and Corporates (Django App: `registration`) - Ridho Mulia (2006597866)
...
### 5. E-Learning on Trading (Django App: `elearning`) - Alisya Andiny Alhabsyi (2106706281)
...
### 6. Trivia on Trading (Django App: `quiz`) - Joan Isva Shanti Andrea (2106707712)
...
### 7. Suggestion Box (Django App: `suggestionbox`) - Muhammad Fahreza Azka Arafat (2106752331)
